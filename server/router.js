...
const router = (app) => {
  ...
  app.get('/dashboard', mid.requiresSecure, mid.requiresLogin,
    (req, res) => {
      res.render('app');
    });
  // Login routes
  ...
  // Password
  app.get('/newPassword', mid.requiresLogin, mid.requiresSecure,
  (req, res) => { res.render('password'); });
  app.post('/updatePass',
  mid.requiresLogin, mid.requiresSecure, controllers.Account.updatePassword);
  // weather
  app.get('/weather', controllers.Weather.getWeather);
  app.get('/forcast', controllers.Weather.getForcast);
  // water body
  app.get('/newWaterBody', mid.requiresSecure, mid.requiresLogin,
  (req, res) => { res.render('newBody'); });
  ...
  // water samples
  app.get('/newWaterTest', mid.requiresSecure, mid.requiresLogin,
